...
def force_user_acknowledge(alert_message, button_key):
    ...
    # ✅ Unique Button Key to Prevent Duplicate Error
...
def check_email_breach(email):
    ...
    if domain in BLOCKED_EMAILS:
        ...
        force_user_acknowledge("⚠️ This email domain is manually blocked! You must acknowledge before continuing.", "email_blocked")
...
def check_website_safety(url):
    if url.startswith("http://"):  
        ...
        force_user_acknowledge("🚨 ALERT: This website is insecure (HTTP detected)! You must acknowledge this before continuing.", "http_alert")
    ...
    if url in BLOCKED_WEBSITES:
        ...
        force_user_acknowledge("⚠️ This website is manually blocked! You must acknowledge before continuing.", "website_blocked")
    ...
    if detect_phishing(url):
        ...
        force_user_acknowledge("⚠️ Possible phishing detected! You must acknowledge before continuing.", "phishing_alert")
    ...
    try:
        ...
        if "matches" in data:
            ...
            force_user_acknowledge("🚨 Google flagged this website as malicious! You must acknowledge this before continuing.", "malicious_url")
