...
def check_email_breach(email):
    ...
    if not is_valid_email(email):
        ...
        force_user_acknowledge("⚠️ Invalid email format detected! You must acknowledge this before continuing.")
    ...
    try:
        ...
        if data.get("status") == "found":
            ...
            force_user_acknowledge("🚨 Malicious email detected! You must acknowledge this before continuing.")
...
def check_website_safety(url):
    ...
    if detect_phishing(url):
        ...
        force_user_acknowledge("⚠️ Possible phishing detected! You must acknowledge this before continuing.")
