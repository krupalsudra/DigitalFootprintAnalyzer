...
def check_email_breach(email):
    ...
    if not is_valid_email(email):
        ...
        st.toast("⚠️ Invalid email format detected!", icon="⚠️")  # Show pop-up
    ...
    try:
        ...
        if data.get("status") == "found":
            ...
            st.toast("🚨 Malicious email detected! Be careful!", icon="🚨")  # Show pop-up
...
def check_website_safety(url):
    if url.startswith("http://"):  
        ...
        st.toast("🚨 This website is insecure (HTTP detected)!", icon="⚠️")  # Show pop-up
    ...
    if detect_phishing(url):
        ...
        st.toast("⚠️ Possible phishing detected!", icon="⚠️")  # Show pop-up
    ...
    try:
        ...
        if "matches" in data:
            ...
            st.toast("🚨 Google flagged this website as malicious!", icon="🚨")  # Show pop-up
