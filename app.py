...
# ✅ Function to Show Popup Alert That Blocks User Input
...
# 📌 Ensure Session State Exists for Blocking Alerts
if "alert_active" not in st.session_state:
    st.session_state["alert_active"] = False

# ✅ Block User Input Until They Click "OK"
if st.session_state["alert_active"]:
    st.warning("⚠️ You must acknowledge the alert before continuing!")
    if st.button("OK"):
        st.session_state["alert_active"] = False
