...
from config import TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID  # ✅ Correct Import
...
def send_telegram_alert(message):
    """Sends a security alert via Telegram."""
    try:
...
def get_logs():
    """Retrieves all stored logs from the JSON file."""
    logs = []
    try:
